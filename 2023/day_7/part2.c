...
int main(void)
{
	...
	for (int l=0; l<NB_LINES; ++l)
	{
		...
		/* We do not actually need to reparse the hand and test all possibilities.
		 * Depending on the "starting" hand and the nb of jokers, we can precisely
		 * know what stronger hand would be possible.*/
		switch (nbJokersInHand)
		{
		case 0:
			/* Do nothing */
			break;
		case 1:
			switch (p_newHand->handType)
			{
			case FOUR_OF_A_KIND:
				/* J is the single card */
				p_newHand->handType = FIVE_OF_A_KIND;
				break;
			case THREE_OF_A_KIND:
				/* J is one of the two single cards */
				p_newHand->handType = FOUR_OF_A_KIND;
				break;
			case TWO_PAIR:
				/* J is the single card */
				p_newHand->handType = FULL_HOUSE;
				break;
			case ONE_PAIR:
				/* J is one of the three single cards */
				p_newHand->handType = THREE_OF_A_KIND;
				break;
			case HIGH_CARD:
				/* J is one of the five single cards */
				p_newHand->handType = ONE_PAIR;
				break;
			}
			break;
		case 2:
			...
			{
			case FULL_HOUSE:
				/* JJ are the two cards in the full house */
				p_newHand->handType = FIVE_OF_A_KIND;
				break;
			case TWO_PAIR:
				/* JJ are one of two pairs */
				p_newHand->handType = FOUR_OF_A_KIND;
				break;
			case ONE_PAIR:
				/* JJ are the one pair */
		...
		case 3:
			...
			{
			case FULL_HOUSE:
				/* JJJ are the three cards in the full house */
				p_newHand->handType = FIVE_OF_A_KIND;
				break;
			case THREE_OF_A_KIND:
				/* JJJ are the three cards */
				p_newHand->handType = FOUR_OF_A_KIND;
				break;
			}
			break;
